...
##   Mr-Wasii	: 	Phishing Tool##   Author 	: 	Mr-Wasii

##   Version 	: 	2.3.4

##   Github 	: 	https://github.com/Mr-Wasii/Mr-Wasii
...
about() {
	...
	cat <<- EOF
		...
		${GREEN} Author   ${RED}:  ${ORANGE}TAHMID RAYAT ${RED}[ ${ORANGE}Mr- ${RED}]

		${GREEN} Github   ${RED}:  ${CYAN}https://github.com/Mr-Wasii

		${GREEN} Social   ${RED}:  ${CYAN}https://Facebook/A Wasim Malik
		...
		${CYAN}  This Tool is made for educational purpose 
		  ...
		  only so you are responsible for your misuse${RED}!${WHITE}${CYAN} Author will not be responsible for 
